...
awful.key({ modkey }, "r", function()
    awful.util.spawn_with_shell( "exe=`dmenu_run -b -nf '#888888' -nb '#222222' -sf '#ffffff' -sb '#285577'` && exec $exe")
end),
...
awful.rules.rules = {
    -- All clients will match this rule.
    {
        ...
        rule_any = {
            class = {
                "Guake", "Steam", "Subl3", "jetbrains-android-studio", "jetbrains-idea-ce"
            }
        },
        properties = {
            --floating = true,
        ...
        rule_any = {
            class = {
                "Firefox", "Leanote", "dingtalk", "Postman"
            }
        },
        properties = {
            floating = true,
...
function bat_notification()
    ...
    if (bat_status == "Discharging") then
        ...
        if (bat_capacity <= 80) then
            myteststatusbar2:set_bg("#ff00ff")
        end
